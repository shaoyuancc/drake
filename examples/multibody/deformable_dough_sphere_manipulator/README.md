...
```
bazel run //examples/multibody/deformable_dough_sphere_manipulator:deformable_dough_sphere_manipulator
```
...
```
bazel run //examples/multibody/deformable_dough_sphere_manipulator:deformable_dough_sphere_manipulator -- --help
```
